    ...
    <div>
      ...
      <form onSubmit={handleSubmit}>
        ...
        <div className="mb-3">
          ...
          <input type="text" className="form-control" id="availableDates" name="availableDates" value={formData.availableDates} onChange={handleChange} />
          {errors.availableDates && <div className="text-danger">{errors.availableDates}</div>}
        </div>
        <div className="mb-3">
          ...
          {errors.hourlyRate && <div className="text-danger">{errors.hourlyRate}</div>}
        </div>
